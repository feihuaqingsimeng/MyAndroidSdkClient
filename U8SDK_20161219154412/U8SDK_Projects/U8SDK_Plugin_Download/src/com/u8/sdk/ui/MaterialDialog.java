...
/**
 * This is a open source dialog on github
...
public class MaterialDialog {
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        mPositiveButton.setBackgroundResource(ResourceHelper.getIdentifier(mContext, "R.drawable.button"));
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        ...
        mNegativeButton.setBackgroundResource(ResourceHelper.getIdentifier(mContext, "R.drawable.button"));
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contv = LayoutInflater.from(mContext).inflate(ResourceHelper.getIdentifier(mContext, "R.layout.layout_materialdialog"), null);
            contv.setFocusable(true);
            contv.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(ResourceHelper.getIdentifier(mContext, "R.drawable.material_dialog_window"));
...
//7
            ...
            mTitleView = (TextView) mAlertDialogWindow.findViewById(ResourceHelper.getIdentifier(mContext, "R.id.title"));
            mMessageView = (TextView) mAlertDialogWindow.findViewById(ResourceHelper.getIdentifier(mContext, "R.id.message"));
            mButtonLayout = (LinearLayout) mAlertDialogWindow.findViewById(ResourceHelper.getIdentifier(mContext, "R.id.buttonLayout"));
            if (mView != null) {
                LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(ResourceHelper.getIdentifier(mContext, "R.id.contentView"));
            ...
            if (mBackgroundResId != 0) {
                LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(ResourceHelper.getIdentifier(mContext, "R.id.material_background"));
            ...
            if(mOnKeyListener != null){
            	mAlertDialog.setOnKeyListener(mOnKeyListener);	
            }
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setBackgroundResource(ResourceHelper.getIdentifier(mContext, "R.drawable.material_card"));
        ...
        public void setView(View view) {
            LinearLayout l = (LinearLayout) mAlertDialogWindow.findViewById(ResourceHelper.getIdentifier(mContext, "R.id.contentView"));
            l.removeAllViews();
        ...
        public void setContentView(View contentView) {
            ...
            LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(ResourceHelper.getIdentifier(mContext, "R.id.message_content_view"));
